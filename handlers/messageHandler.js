...
"जीवन की सभी परेशानियों - बीमारी, गरीबी, दुःख - से मुक्ति का सही तरीका इस पुस्तक में है। | The right way to get rid of all troubles - disease, poverty, sorrow - is in this book.",
"यह पुस्तक हजारों लोगों की ज़िन्दगी बदल चुकी है! आध्यात्मिक ज्ञान से भरपूर। | This book has changed thousands of lives! Full of spiritual knowledge.",
...
⬅️ पीछे जाने के लिए *0* भेजें` });
      ...
      // New step: Ask if the post office name is their village/city
...
⬅️ पीछे जाने के लिए *0* भेजें` });
    ...
    // Confirm Village Selection (New Step)
    if (state.step === 'confirm_village_selection') {
      if (isYes(text)) {
        // User confirmed post office name is their village/city
...
⬅️ पीछे जाने के लिए *0* भेजें` });
        ...
        // User wants to select from village list
...
⬅️ पीछे जाने के लिए *0* भेजें` });
        ...
        // User wants to write custom address
...
⬅️ पीछे जाने के लिए *0* भेजें` });
    ...
    // Confirm Custom Address (New Step)
